      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="group inline-flex items-center gap-2 bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 hover:border-primary-300 text-surface-700 dark:text-surface-200 font-semibold text-sm px-4 py-2.5 rounded-xl transition-all"
          >
